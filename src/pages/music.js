...
const MusicPage = () => {
  ...
  return (
    <Layout>
      <SEO title="Music" />
      {nowPlaying.item ? (
        <div className="w-screen h-screen top-16 fixed z-0">
          <img
      ...
      <div className="relative z-30 bg-pink-50 bg-opacity-75 dark:bg-black dark:bg-opacity-90 backdrop-filter backdrop-blur-2xl backdrop-brightness-200 w-full">
